...
public class SaturdayActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listExercises = (ListView)findViewById(R.id.saturdayList);
        final DBHandler dB = new DBHandler(this);
        final String dbName = "SATEXEC";
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SaturdayActivity.this, ExercisesActivity.class);
        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SaturdayActivity.this, ExeActivity.class);
