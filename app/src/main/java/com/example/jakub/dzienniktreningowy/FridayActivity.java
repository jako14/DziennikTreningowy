...
public class FridayActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listExercises = (ListView)findViewById(R.id.fridayList);
        final DBHandler dB = new DBHandler(this);
        final String dbName = "FRIEXEC";
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(FridayActivity.this, ExercisesActivity.class);
        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(FridayActivity.this, ExeActivity.class);
