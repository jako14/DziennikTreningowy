...
public class SundayActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listExercises = (ListView)findViewById(R.id.sundayList);
        final DBHandler dB = new DBHandler(this);
        final String dbName = "SUNEXEC";
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SundayActivity.this, ExercisesActivity.class);
        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SundayActivity.this, ExeActivity.class);
