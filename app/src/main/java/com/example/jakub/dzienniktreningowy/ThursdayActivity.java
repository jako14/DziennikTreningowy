...
public class ThursdayActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listExercises = (ListView)findViewById(R.id.thursdayList);
        final DBHandler dB = new DBHandler(this);
        final String dbName = "THUEXEC";
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ThursdayActivity.this, ExercisesActivity.class);
        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ThursdayActivity.this, ExeActivity.class);
