...
public class MondayActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listExercises = (ListView)findViewById(R.id.mondayList);
        final DBHandler dB = new DBHandler(this);
        final String dbName = "MONEXEC";

        refreshList(dbName,dB,listExercises);
        ImageButton addButton = (ImageButton)findViewById(R.id.addButton);
        ImageButton chartButton = (ImageButton)findViewById(R.id.chartButton);

        addButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                    Intent intent = new Intent(MondayActivity.this, ExercisesActivity.class);
        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MondayActivity.this, ExeActivity.class);
